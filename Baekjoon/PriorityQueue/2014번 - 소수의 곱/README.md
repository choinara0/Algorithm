...
|---|---|---|---|---|---|
|2 초|	128 MB|	11535|	2623|	1815|	22.759%|
...
- 다음 줄에는 K개의 소수가 오름차순으로 주어진다. 같은 소수가 여러 번 주어지는 경우는 없으며, 주어지는 소수는 모두 541보다 작거나 같은 자연수이다.
...
### 문제 출처
[백준](https://www.acmicpc.net/problem/2014)