...
|---|---|---|---|---|---|
|1 초|	128 MB|	1727|	488|	344|	28.036%|
...
### 입력
- 첫째 줄에 사람의 수를 나타내는 \(N\)이 주어진다. \((1 \le N \le 100,000)\) 
- 둘째 줄부터 \(N\)개의 줄에 걸쳐서 각 사람의 컴퓨터 이용 시작 시각 \(P\)와 종료 시각 \(Q\)가 주어진다. \((0 \le P \lt Q \le 1,000,000)\) 
...
### 문제 출처
[백준](https://www.acmicpc.net/problem/12764)