...
|---|---|---|---|---|---|
|1 초|	128 MB|	2570|	895|	757|	34.917%|
...
- 각 과목마다 2줄의 입력이 주어지는데 첫째 줄에는 각 과목에 신청한 사람 수 Pi과 과목의 수강인원 Li이 주어지고 그 다음 줄에는 각 사람이 마일리지를 얼마나 넣었는지 주어진다. (1 ≤ Pi ≤100, 1 ≤ Li ≤ 100)
...
### 문제 출처
[백준](https://www.acmicpc.net/problem/12018)